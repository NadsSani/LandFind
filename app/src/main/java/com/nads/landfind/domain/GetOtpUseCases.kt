...
class GetOtpUseCases @Inject constructor(private val  landFindDefaultRepository: LandFindRepository) {

    suspend operator fun invoke(otp:String): Result<DataValues> {

        wrapEspressoIdlingResource {
            return landFindDefaultRepository.getOtp(otp)
        }
    }
